...
const Header: React.FC<HeaderProps> = ({ timelineIdx, onSetTlIdx }) => {
  ...
  const socialIcons: ISocialIcon[] = useMemo(
    () => [
      {
        icon: faGithub,
        link: "https://github.com/jayantvishwakarma/",
      },
      {
        icon: faInstagram,
        link: "https://www.instagram.com/iamjayantvishwakarmaofficial/",
      },
      {
        icon: faYoutube,
        link: "https://youtube.com/@developerjayant",
      },
      {
        icon: faLinkedin,
        link: "https://www.linkedin.com/in/jayant-vishwakarma-21030825a/",
      },
    ],
    []
  );
  ...
  return (
    <>
      ...
      <MailContainer ref={mailContainerEl}>
        <Mail href="vishwakarmajayant0@gmail.com">vishwakarmajayant0@gmail.com</Mail>
      </MailContainer>
    </>
  );
};
